...
const AllowedDomEvents = [
  "INIT_HIGHLIGHT_COMMENTS",
  "CANCEL_HIGHLIGHT_COMMENTS",
  "PING",
]
...
window.addEventListener(
  ...
  (event) => {
    ...
    if (event.data.contents) {
      ...
      if (
        AllowedDomEvents.includes(eventName) &&
        eventName === "INIT_HIGHLIGHT_COMMENTS"
      ) {
      ...
      if (
        AllowedDomEvents.includes(eventName) &&
        eventName === "CANCEL_HIGHLIGHT_COMMENTS"
      ) {
      ...
      if (!gotButton) {
        ...
        buttonElement.addEventListener("click", function () {
          ...
          setTimeout(function () {
            ...
            let commenter_name = comment.querySelector(
            ...
            let commentHTML = comment.querySelector(
